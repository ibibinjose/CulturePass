...
exports.australianPostcodes = void 0;
exports.getPostcodesByState = getPostcodesByState;
exports.getPostcodeData = getPostcodeData;
exports.getPostcodesByPlace = getPostcodesByPlace;
exports.calculateDistance = calculateDistance;
exports.findNearestPostcodes = findNearestPostcodes;
exports.filterByProximity = filterByProximity;
exports.australianPostcodes = [
...
const postcodesByState = new Map();
const postcodesByPostcode = new Map();
const postcodesByPlace = new Map();
exports.australianPostcodes.forEach((data) => {
...
function getPostcodesByPlace(placeName) {
...
function findNearestPostcodes(latitude, longitude, count = 5) {
    return exports.australianPostcodes
        .map((postcode) => ({
        ...postcode,
...
function filterByProximity(items, userLatitude, userLongitude, radiusKm = 50) {
    return items.filter((item) => {
        const distance = calculateDistance(userLatitude, userLongitude, item.latitude, item.longitude);
        return distance <= radiusKm;
    });
}
//# sourceMappingURL=australian-postcodes.js.map