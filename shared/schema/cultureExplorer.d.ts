 ...
 */
export declare const BADGE_TIER_THRESHOLDS: Record<Exclude<CultureBadgeTier, 'none'>, number>;
/** Multiplier applied to base reward points when the event is for an explored, non-root culture. */
export declare const CULTURE_EXPLORER_POINT_MULTIPLIER = 2;
/** Admin-curated quest. */
...
//# sourceMappingURL=cultureExplorer.d.ts.map