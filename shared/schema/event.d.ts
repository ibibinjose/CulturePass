export type EventType = 'festival' | 'concert' | 'workshop' | 'puja' | 'sports' | 'food' | 'cultural' | 'community' | 'exhibition' | 'conference' | 'networking' | 'nightlife' | 'family' | 'film' | 'theatre' | 'comedy' | 'dance' | 'wellness' | 'market' | 'tour' | 'charity' | 'religious' | 'other';
