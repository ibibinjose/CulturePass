...
exports.HostProfileFormDataSchema = exports.HostProfileSchema = exports.ProfessionalDataSchema = exports.RateCardTierSchema = exports.ArtistDataSchema = exports.AvailabilityDateSchema = exports.PortfolioItemSchema = exports.BusinessDataSchema = exports.PaymentMethodSchema = exports.CatalogueItemSchema = exports.VenueDataSchema = exports.AccessibilityFeaturesSchema = exports.ExceptionDateSchema = exports.RecurringScheduleSchema = exports.TimeRangeSchema = exports.TechnicalSpecsSchema = exports.OrganiserDataSchema = exports.PastEventSchema = exports.CommunityDataSchema = exports.GrowthDataPointSchema = exports.LicenceSchema = exports.AddressSchema = exports.SocialLinkSchema = void 0;
...
exports.HostProfileSchema = zod_1.z.object({
    ...
    indigenousTags: zod_1.z.array(zod_1.z.string().max(50)).max(10).optional(),
