...
export type CommunityCategory = 'cultural' | 'local_community' | 'arts_sports_club' | 'business' | 'brand' | 'council' | 'charity' | 'club' | 'professional';
...
export type RepresentativeRole = 'federal_mp' | 'state_mp' | 'mayor' | 'deputy_mayor' | 'councillor' | 'community_leader' | 'artist';
/** Civic color token mapping — drives UI badge and card styling */
export declare const CIVIC_TIER_COLORS: Record<CivicTier, string>;
export declare const REPRESENTATIVE_ROLE_COLORS: Record<RepresentativeRole, string>;
export declare const CIVIC_TIER_LABELS: Record<CivicTier, string>;
export declare const REPRESENTATIVE_ROLE_LABELS: Record<RepresentativeRole, string>;
...
export type CommunityLegalStatus = 'incorporated_association' | 'nonprofit' | 'company_limited_by_guarantee' | 'cooperative' | 'indigenous_corporation' | 'informal' | 'other';
export declare const COMMUNITY_LEGAL_STATUS_LABELS: Record<CommunityLegalStatus, string>;
