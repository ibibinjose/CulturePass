...
export const SOCIAL_LINKS = [
  { key: 'instagram', label: '@culturepassapp', url: 'https://instagram.com/culturepassapp', icon: 'logo-instagram' },
  { key: 'instagram-india', label: '@cultureindiaapp', url: 'https://instagram.com/cultureindiaapp', icon: 'logo-instagram' },
