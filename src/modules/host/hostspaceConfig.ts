...
export const HOSTSPACE_CREATE_CATEGORIES: HostspaceCreateCategory[] = [
  {
    ...
    aliases: ['communities'],
    label: 'Community',
    route: '/hostspace/create/community',
  ...
  },
  {
    ...
    aliases: ['businesses'],
    label: 'Business',
    route: '/hostspace/create/business',
  ...
  },
  {
    ...
    label: 'Organizer',
    route: '/hostspace/create/organizer',
  ...
  },
  {
    ...
    aliases: ['activity'],
    label: 'Activities',
    route: '/hostspace/create/activities',
    ...
    color: CultureTokens.coral,
    kind: 'surface',
    createRoute: '/activities',
  },
  {
    id: 'travel',
    aliases: ['trips'],
    label: 'Travel',
    route: '/hostspace/create/travel',
  ...
  },
  {
    ...
    aliases: ['shop', 'shops'],
    label: 'Shopping',
    route: '/hostspace/create/shopping',
