...
import { PROFILE_STYLES } from '@/design-system/tokens/profileStylesTokens';
...
export const hero = StyleSheet.create({
  ...
  name: { fontSize: FontSize.title, fontFamily: FontFamily.bold, color: PROFILE_STYLES.onHero, letterSpacing: -0.4, textAlign: 'center' },
  ...
  statsBar: {
    ...
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 12 },
      android: { elevation: 4 },
  ...
  statNum: { fontFamily: FontFamily.bold, fontSize: 22, color: PROFILE_STYLES.onHero, letterSpacing: -0.5 },
...
export const act = StyleSheet.create({
  ...
  btn: {
    ...
    overflow: 'hidden',
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4 },
      android: { elevation: 2 },
...
export const tier = StyleSheet.create({
  card: {
    ...
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8 },
      android: { elevation: 3 },
  ...
  upgradeTxt: { fontSize: FontSize.caption, fontFamily: FontFamily.bold, color: PROFILE_STYLES.onHero, lineHeight: 17 },
});
...
export const prk = StyleSheet.create({
  ...
  card: {
    ...
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 8 },
      android: { elevation: 3 },
...
export const cpid = StyleSheet.create({
  card: {
    ...
    borderWidth: 1,
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.12, shadowRadius: 10 },
      android: { elevation: 3 },
  ...
  qrWrap: {
    ...
    borderRadius: 12,
    borderWidth: 1,
    backgroundColor: PROFILE_STYLES.surface,
  },
  openBtn: {
    marginTop: 2,
    borderRadius: 12,
  ...
  openBtnText: { color: PROFILE_STYLES.onHero, fontSize: FontSize.caption, fontFamily: FontFamily.bold },
});
...
export const det = StyleSheet.create({
  card: {
    ...
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6 },
      android: { elevation: 2 },
...
export const set = StyleSheet.create({
  card: {
    borderRadius: 20, borderWidth: 1, padding: Spacing.xs,
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 10 },
      android: { elevation: 3 },
...
export const sout = StyleSheet.create({
  btn: {
    ...
    ...Platform.select<ViewStyle>({
      ios: { shadowColor: PROFILE_STYLES.shadow, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 6 },
      android: { elevation: 1 },
